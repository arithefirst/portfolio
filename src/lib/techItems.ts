...
export const items: item[] = [
  ...
  { name: "git", type: "tool", description: '"the information manager from hell" -Linus Torvalds (Creator of Git)', caps: false },
  {
    name: "github",
    type: "tool",
    description:
  ...
  },
  {
    name: "neovim",
    type: "tool",
    description: "Neovim is a Vim-based text editor engineered for extensibility and usability, to encourage new applications and contributions.",
    caps: false,
  },
  {
    name: "nodejs",
    type: "tool",
    description: "Node.js is a JavaScript runtime built on Chrome's V8 engine that enables the execution of Javascript outside of the browser",
    caps: false,
  },
  {
    name: "npm",
